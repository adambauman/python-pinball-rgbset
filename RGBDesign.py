#
# BauTek Mini Pinball RGBSet Designer
# Provides a menu-driven method to set lighting parameters.
#
# 3/2016 - Adam J. Bauman - https://bitbucket.org/adambauman/python-rgbset
#
